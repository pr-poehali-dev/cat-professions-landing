...
const PetTheCat = () => {
  ...
  const catImages = {
    angry: "https://cdn.poehali.dev/files/0ba2bb7d-8eaa-4281-924a-29ab6cd6631e.png",
    neutral: "https://cdn.poehali.dev/files/a3762558-353d-4dcd-a3f5-bbba16474f44.png",
    happy: "https://cdn.poehali.dev/files/9e621a9f-ffb2-4cf0-9358-6848bd0484a5.png",
    veryHappy: "https://cdn.poehali.dev/files/38e1edae-2c03-486a-b0f7-b4493d15353f.png",
  };
    ...
    <section className="py-16 px-4 bg-[#121212]" id="pet-the-cat">
      <div className="container mx-auto max-w-2xl">
        ...
        <p className="text-center mb-10 text-gray-400 max-w-lg mx-auto">
          Интерактивный кот ждет ваших поглаживаний. Но помните: все коты непредсказуемы!
        </p>
        ...
        <div className="bg-[#1A1A1A] rounded-xl p-6 shadow-lg">
          <div className="flex flex-col items-center">
            ...
            <div className="text-center mb-4">
              <p className="text-gray-300 mb-2">
                ...
                {petCount >= 8 && petCount < 15 && "Кот в восторге от ваших поглаживаний!"}
                {petCount >= 15 && "Кот перевозбуждён и требует личного пространства!"}
              </p>
              <p className="text-gray-400 text-sm">
                Поглаживаний: <span className="text-[#D35536] font-bold">{petCount}</span>
              </p>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-gray-500 italic">
              * Все поглаживания осуществляются с согласия кота. Компания не несет ответственности за последствия.
            </p>
          </div>
        </div>
      </div>
